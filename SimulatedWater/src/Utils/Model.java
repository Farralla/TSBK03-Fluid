...
public class Model {
	...
	private void BuildModelVAO2(){
		...
		//c: glBufferData(GL_ARRAY_BUFFER, mNumVertices*3*4, mVertexArray, GL_STATIC_DRAW);
		...
		if(mNormalArray != null){
			...
			//c: glBufferData(GL_ARRAY_BUFFER, m->numVertices*3*sizeof(GLfloat), m->normalArray, GL_STATIC_DRAW);
		...
		if (mTexCoordArray != null)
		{
			...
			//c: glBufferData(GL_ARRAY_BUFFER, m->numVertices*2*sizeof(GLfloat), m->texCoordArray, GL_STATIC_DRAW);
