...
public class NiftyGUI {
	  ...
	  protected static LwjglInputSystem initInput() throws Exception {
	  ...
	  private void renderLoop(final Nifty nifty) {
	    boolean done = false;
	  ...
	  public static class MyScreenController extends DefaultScreenController {
	    ...
	    public void start(final String id, final ButtonClickedEvent event) {
